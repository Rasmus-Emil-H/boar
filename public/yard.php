...
function dd(mixed $input, $title = ''): void {
  displayDD($input, $title);
  exit;
}

function d(mixed $input, $title = ''): void {
  displayDD($input, $title);
  echo '<hr />';
}
...
function getIndex(array|object $iterable, int|string $expectedIndex): ?object {
