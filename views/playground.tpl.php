<div class="h-100">
    <div class="w-75 mx-auto mt-2">
        <div class="request">
            <div class="form-floating mx-auto my-auto">
                <form method="POST">
                    <textarea name="Input" class="w-100 border-0 vh50 noresize p-2" placeholder="echo 123;" id="floatingTextarea2"></textarea>
    ...
    <div class="receive w-75 mx-auto">
        <div class="form-floating mx-auto my-auto" style="margin-left:2px !important;">
            <textarea name="Input" class="w-100 border-0 vh50 noresize p-2 bg-white" disabled id="inject"></textarea>
        </div>
    </div>
</div>
