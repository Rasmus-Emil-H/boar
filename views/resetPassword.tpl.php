                        ...
                        <div class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel" aria-labelledby="ex1-tab-1">
                            <form class="login-form center flex-column" method="POST" action="/auth/resetPassword">
                                <div class="form-group">
                                    <label class="form-label mb-1"><?= \app\core\src\miscellaneous\CoreFunctions::ths('Enter new password'); ?></label>
                                    <input type="password" required name="password" class="form-control form-control-lg">
                                </div>
                                <div class="form-group mb-4">
                                    <label class="form-label mb-1"><?= \app\core\src\miscellaneous\CoreFunctions::ths('Repeat password'); ?></label>
                                    <input type="password" required name="passwordRepeat" class="form-control form-control-lg">
                                </div>
                                <?= (new \app\core\src\tokens\CsrfToken())->insertHiddenToken(); ?>
                                <button type="submit" class="btn btn-primary btn-lg w-100 mb-3"><?= \app\core\src\miscellaneous\CoreFunctions::ths('Reset password'); ?></button>
